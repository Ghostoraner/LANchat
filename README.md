...
Подробное описание архитектуры, протокола, установки, сборки релизов, модели безопасности, FAQ и устранения неполадок находится в папке [`docs/`](docs/).

👉 **[Открыть полную документацию LANChat](docs/LANChat%20-%20Documentation.md)**

Документация особенно полезна, если вы хотите:

- разобраться в архитектуре сервера и клиентов;
- написать собственный клиент, совместимый с LANChat;
- узнать подробности JSON-протокола и типов сообщений;
- собрать релизные бинарники;
- настроить подключение и решить проблемы со сборкой или запуском.
